...
class FW_Option_Type_Table extends FW_Option_Type
{
	...
	protected function _enqueue_static( $id, $option, $data ) {
		...
		$localization_array = array(
			'msgEdit' => __( 'Edit', 'curiosity-elements' ),
	...
	protected function _render( $id, $option, $data ) {
		...
		if ( ! $table_shortcode ) {
			trigger_error(
				__( 'table-builder option type must be inside the table shortcode', 'curiosity-elements' ),
				E_USER_ERROR
			);
		}
	...
	protected function _get_defaults() {
		return apply_filters( 'fw_option_type_table_defaults', array(
			'header_options'  => array(
				'table_purpose' => array(
					'type'    => 'select',
					'label'   => __( 'Table Styling', 'curiosity-elements' ),
					'desc'    => __( 'Choose the table styling options', 'curiosity-elements' ),
					'choices' => array(
						'tabular' => __( 'Use the table to display tabular data', 'curiosity-elements' ),
					),
					'value'   => 'tabular',
					'attr'    => array(
			...
			'row_options'     => array(
				'name' => array(
					...
					'desc'    => false,
					'choices' => array(
						'default-row' => __( 'Default row', 'curiosity-elements' ),
						'heading-row' => __( 'Heading row', 'curiosity-elements' ),
						'pricing-row' => __( 'Pricing row', 'curiosity-elements' ),
						'button-row'  => __( 'Button row', 'curiosity-elements' ),
						'switch-row'  => __( 'Row switch', 'curiosity-elements' )
					),
				)
			),
			'columns_options' => array(
				'name' => array(
					...
					'desc'    => false,
					'choices' => array(
						'default-col'   => __( 'Default column', 'curiosity-elements' ),
						'desc-col'      => __( 'Description column', 'curiosity-elements' ),
						'highlight-col' => __( 'Highlight column', 'curiosity-elements' ),
						'center-col'    => __( 'Center text column', 'curiosity-elements' )
					),
				)
			),
			'content_options' => array(
				...
				'pricing-row' => array(
					...
					'description' => array(
						...
						'value'        => '',
						'attr'         => array(
							'placeholder' => __( 'per month', 'curiosity-elements' )
						),
						'wrapper_attr' => array(
							'class' => 'fw-col-sm-6'
						)
				...
				'button-row'  => array(
					'button' => ( $button = fw()->extensions->get( 'shortcodes' )->get_shortcode( 'button' ) )
						? array(
							'type'          => 'popup',
							'popup-title'   => __( 'Button', 'curiosity-elements' ),
							'button'        => __( 'Add', 'curiosity-elements' ),
